<div>
    ...
    <section
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            <p class="text-gray-black text-sm tracking-[0.12em] mb-2">{{ $hero->small_title }}</p>
                            <h1
                        ...
                        <div class="md:w-1/2 w-full flex justify-center items-center relative">
                            <img src="{{asset('hero/'.$hero->banner)}}" alt="">
                            <div class="inline-block absolute top-0 right-0">
                                <img src="{{asset('frontend/assets/images/all-img/discount.png')}}" alt="">
                                <p class="absolute top-[33px] text-[#F05C52] text-4xl font-bold right-9">{{(int)$hero->discount }}%</p>
        ...
        <img src="{{asset('frontend/assets/images/svg/banner-shapes.svg')}}" alt=""
            ...
            <div class="swiper brandSwiper overflow-hidden">
                <div class="swiper-wrapper items-center">
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-01.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-02.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-03.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-04.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-05.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-06.png')}}" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="{{asset('frontend/assets/images/all-img/brand-logo-07.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <div>
                                        <button class="cart-icon"
                                            wire:click.prevent="CartStore({{$product->id}},'{{$product->name}}',{{$product->price}})">
                            ...
                            @auth
                            <a wire:click.prevent="{{ $isInWishlist ? 'RemoveFromWishlist' : 'AddToWishlist' }}({{$product->id}},'{{$product->name}}',{{$product->price}})"
                                href="wishlist.html" class="heart-icon">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke-linejoin="round" fill="{{ $isInWishlist ? 'red' : 'none' }}" />
                                    <!-- Set the fill attribute based on $isInWishlist -->
                                </svg>
                            </a>
                            @else
                            <button text='Please login first' class="heart-icon">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M2.63268 10.6315C1.64909 7.56068 2.79768 4.05077 6.02251 3.01218C6.85874 2.74461 7.74682 2.68088 8.61268 2.8263C9.47855 2.97173 10.2971 3.3221 11 3.84818C12.3338 2.81693 14.2743 2.4686 15.9683 3.01218C19.1923 4.05077 20.3491 7.56068 19.3664 10.6315C17.8356 15.499 11 19.2482 11 19.2482C11 19.2482 4.21484 15.5558 2.63268 10.6315V10.6315Z"
            ...
            <div id="portfoliolist" class="portfoliolist justify-center mx-auto">
                <div class="mix all featured" data-cat="featured">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{asset('frontend/assets/images/all-img/f-product-01.png')}}" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                ...
                <div class="mix all trending" data-cat="trending">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{asset('frontend/assets/images/all-img/f-product-02.png')}}" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                ...
                <div class="mix all featured" data-cat="featured">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{asset('frontend/assets/images/all-img/f-product-03.png')}}" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                ...
                <div class="mix all best-sellers" data-cat="best-sellers">
                    <div class="product-card">
                        <a href="product-details.html">
                            <div class="product-thumb">
                                <img src="{{asset('frontend/assets/images/all-img/f-product-04.png')}}" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                            ...
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="{{asset('testimonial/'.$testimonial->image)}}" alt=""
