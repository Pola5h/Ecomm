                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img
                                        src="{{asset('frontend/assets/images/all-img/t-product-01.png')}}" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img
                                        src="{{asset('frontend/assets/images/all-img/t-product-02.png')}}" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card-02">
                            <div class="product-thumb">
                                <a href="products.html"><img
                                        src="{{asset('frontend/assets/images/all-img/t-product-03.png')}}" alt=""></a>
                            </div>
                            ...
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="{{asset('frontend/assets/images/all-img/testimonials.png')}}" alt=""
