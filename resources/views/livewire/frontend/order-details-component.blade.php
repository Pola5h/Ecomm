                        ...
                        <div class="">
                            ...
                            <div class="px-8 py-8 flex flex-col md:flex-row md:flex-wrap gap-6 xl:gap-2 xl:justify-between md:items-center">
                                <div class="flex-wrap">
                                    ...
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">#{{ $Order->order_id }}</span>
                                </div>
                                <div class="flex-wrap">
                                    <p class="text-[#9A9CAA] font-display text-[14px] leading-[100%] capitalize pb-[10px]">Date:</p>
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">{{$Order->created_at->format('M j, Y')}}</span>
                                </div>
                                <div class="flex-wrap">
                                    <p class="text-[#9A9CAA] font-display text-[14px] leading-[100%] capitalize pb-[10px]">Email:</p>
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">{{ $billinginfo->email }}</span>
                                </div>
                                <div class="flex-wrap">
                                    <p class="text-[#9A9CAA] font-display text-[14px] leading-[100%] capitalize pb-[10px]">Total:</p>
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">${{ $Order->total }}</span>
                                </div>
                                <div class="flex-wrap">
                                    <p class="text-[#9A9CAA] font-display text-[14px] leading-[100%] capitalize pb-[10px]">Status:</p>
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">{{ ['Pending', 'Shipped', 'Delivered', 'Canceled'][$Order->order_status - 1] ?? 'Invalid Status' }}
                                    </span>
                                </div>
                                <div class="flex-wrap">
                                    <p class="text-[#9A9CAA] font-display text-[14px] leading-[100%] capitalize pb-[10px]">Payment Method:</p>
                                    <span class="text-gray-black font-display text-[20px] leading-[120%] font-medium">{{ $Order->payment_type == 1 ? "Cash On Delivery" : ($Order->order_status == 2 ? "Stripe" : "") }}: {{ ['Pending', 'Paid', 'Failed'][$Order->payment_status - 1] ?? 'Invalid Status' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <td class="text-sm px-6 pt-6">
                                                <div class="flex justify-between items-center">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <p>{{ \App\Models\Product::findOrFail($orderItem->product_id)->name }}</p>
