<div class="box xl:w-[312px]">
    <div class="">
        <div class="p-6">
            <h2
                class="xl:text-2xl acc-title text-[22px]  text-[#272343] font-medium mb-6 font-display text-center">
                Change Profile Photo</h2>

            <div class="pb-[26px] mx-auto">
                <img class="w-[150px] h-[150px] rounded-full mx-auto object-cover"
                    src="{{ asset('/frontend/assets/images/all-img/profile-photo.png') }}"
                    alt="image description" id="blah">
            </div>

            <div class="flex justify-center pb-3">

                <input type="file" id="real-file" hidden="hidden" onchange="readURL(this);"
                ...
                <button type="button" id="custom-button"
                    ...
                    <span class="">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M12 19.5V9.5M12 9.5L8.5 13M12 9.5L15.5 13"
                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
