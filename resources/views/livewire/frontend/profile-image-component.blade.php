    ...
    <div class="">
        <div class="p-6">
            <h2 class="xl:text-2xl acc-title text-[22px]  text-[#272343] font-medium mb-6 font-display text-center">
                ...
                <form id="upload-form" method="POST" action="{{ route('user.updateProfilePhoto') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="pb-[26px] mx-auto">
                        <img class="w-[150px] h-[150px] rounded-full mx-auto object-cover"
                            src="{{ asset(Auth::user()->image ? 'images/'.Auth::user()->image : 'frontend/assets/images/all-img/profile-photo.png') }}" alt="image description" id="blah">
                    </div>
