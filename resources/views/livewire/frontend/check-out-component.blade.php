        ...
        <div class="cart-total lg:w-2/3 w-full">
          <div class="billing-info-wrapper">
            <div class="p-8">
              ...
              <!-- <div class="cursor-pointer"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" class="cursor-pointer test" type="checkbox" value="yes"><label for="wp-comment-cookies-consent" >Ship to a different address</label></div> -->
        ...
        <div class="cart-total p-8 h-auto lg:w-1/3 w-full">
          ...
          <div class="flex justify-between items-center pb-4">
            <div class="flex items-center gap-3">
              <div class="w-[50px] h-[50px]">
                ...
                <img src="{{ asset('product/thumbnail/'.$item->model->thumbnail) }}" alt="" class="w-full h-full object-cover">
                @endif
 
            </div>
              <div class="flex gap-[6px]">
                <p class="font-display2 text-[14px] leading-[100%] font-normal text-[#272343]">{{ substr($item->model->name, 0, 20) }}</p>
          ...
          <div class="subtotal-info">
            ...
            <div class="flex justify-between items-center">
              ...
              <p class="text-gray-black text-[22px] leading-[120%] font-display font-semibold">${{Cart::instance('cart')->total() }}</p>
            </div>
            ...
            <button class="w-full flex gap-3 items-center justify-center mt-5 bg-accents hover:bg-[#272343] rounded-lg py-[16px] text-[18px] font-bold font-display leading-[110%] text-gray-white  transition-all duration-300">Place Order <span>
