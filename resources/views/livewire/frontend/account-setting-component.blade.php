    ...
    <div class="w-full ">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('user.profile.update') }}" method="POST">
                ...
                <div class="w-full mb-5">
                    <textarea name="address" placeholder="Input Your address"
                        class="input-box focus:outline-none focus:ring-2 focus:ring-accents font-display transition duration-300 ease-in-out">{{ old('address', $user->address ?? '') }}</textarea>
                </div>
