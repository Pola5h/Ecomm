  ...
  <div class="container-xl d-flex flex-column justify-content-center">
    ...
    <div class="row row-cards">
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            <table class="table table-vcenter table-mobile-md card-table">
              ...
              <tbody>
                @foreach ($data as $key => $testimonials)
                <tr>
                  <td>{{ $key + 1 }}</td>
                  <td data-label="Name">
                    <div class="d-flex py-1 align-items-center">
                      <span class="avatar me-2"
                        style="background-image: url('{{ $testimonials->image ? asset('testimonial/' . $testimonials->image) : asset('../backend/assets/static/logo.svg') }}')"></span>

                    </div>
                  </td>

                  <td class="text-muted" data-label="Role">
                    {{$testimonials->client_name}} </td>
                  <td>
                    <td class="text-muted" data-label="Role">
                      {{$testimonials->designation}} </td>
                    <td>
                    <div class="btn-list flex-nowrap">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="{{ route('admin.testimonial.edit', $testimonials->id) }}">
                            Edit
                          </a>
      ...
      <div class="col-4">
        ...
        <form method="post" class="card" action="{{ route('admin.testimonial.store') }}" enctype="multipart/form-data">
          @csrf
          <div class="card-header">
        ...
        <form method="post" class="card" action="{{ route('admin.testimonial.update',$editData->id) }}"
              ...
              <div class="col-xl-8">
                <div class="row">
                  <div class="col-md-6 col-xl-12">
                    ...
                    <div class="mb-3">
                      <div class="col-auto mb-3">
                        <img src="{{ asset('testimonial/' . $editData->image) }}" width="200" class="img-icon" />
                      </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control"
                        value="{{ !empty($editData->client_name) ? $editData->client_name : '' }}" name="name"
                        placeholder="Required..." />
                    </div>
                    <div class="mb-3">
                      <label class="form-label required">Designation</label>
                      <input type="text" class="form-control"
                        value="{{ !empty($editData->designation) ? $editData->designation : '' }}" name="name"
                        placeholder="Required..." />
                    </div>
                    <div class="mb-3">
                      <label class="form-label required">Testimonial</label>

                      <textarea id="tinymce-mytextarea2" name="description">{!! isset($editData->testimonial) ? $editData->testimonial : '' !!}</textarea>
