  ...
  <div class="container-xl d-flex flex-column justify-content-center">
    ...
    <div class="row row-cards">
                    ...
                    <div class="btn-list flex-nowrap">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="{{ route('admin.category.edit', $categories->slug) }}">
                            Edit
                          </a>
                          <form action="{{ route('admin.category.destroy', $categories->slug) }}" method="POST">
                            @csrf
                            @method('DELETE')
      ...
      <div class="col-4">
        ...
        <form method="post" class="card" action="{{ route('admin.category.update',$editData->slug) }}"
              ...
              <div class="col-xl-8">
                <div class="row">
                  <div class="col-md-6 col-xl-12">
                    ...
                    <div class="mb-3">
                      <div class="col-auto mb-3">
                        <img src="{{ asset('category/' . $editData->icon) }}" width="200" class="img-icon" />
                      </div>
