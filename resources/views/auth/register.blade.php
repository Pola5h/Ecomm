    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="Text" name="name" class="form-control" placeholder="Polash" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <script> 
                            ...
                            document.querySelector('.b').addEventListener('mousedown', function() {
                                document.getElementById('password_confirmation').type = 'text';
                            });
                        
                            document.querySelector('.b').addEventListener('mouseup', function() {
            ...
            <div class="text-center text-muted mt-3">
                Have a account? <a href="{{ URL('login') }}" tabindex="-1">Sign up</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
